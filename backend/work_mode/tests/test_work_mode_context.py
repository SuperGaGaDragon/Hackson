...
class WorkModeContextTest(TestCase):
    def test_lead_context_contains_tools_manifest_windows_recent_content_and_budget(self) -> None:
        ...
        self.assertIn("compose_artifacts", context["availableTools"])
        ...
        self.assertIn("compose_artifacts", context["toolSchemas"])
        self.assertIn("web_search", context["toolSchemas"])
        self.assertIn("evaluate_product", context["toolSchemas"])
        self.assertIn("composeArtifactsExample", context["toolExamples"])
        ...
        self.assertEqual(context["toolSchemas"]["compose_artifacts"]["arguments"]["artifactKind"], "draft|revision|final")
