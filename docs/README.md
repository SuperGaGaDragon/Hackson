...
- docs/ folder includes designation files. 

- docs/README.md: introductions of docs/ folder
- docs/需求文档v1.md: Brainstorm of ideas, functions etc. 
