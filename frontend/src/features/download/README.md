...
## folder structure
|-README.md download feature guide
|-CompanionDownloadPage.jsx public Mac alpha Desktop Companion download page

## 代办
- Add Windows and Intel Mac builds only after signed artifacts exist.
