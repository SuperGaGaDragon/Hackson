...
- 架构思路
  - Load idle history, select one idle conversation, tick one Agent reply, join into companion_1, then continue the child conversation.
...
|-IdlePage.jsx idle history, new topic modal, timeline, tick, join, and status UI
